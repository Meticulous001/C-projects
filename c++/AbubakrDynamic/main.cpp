...
main()
{
    Student *studArray[5]={new Student("Abubakar","Salawu",9,"May",2014), new Student("Adejumo","Shola",29), new Student("Abdul","Ganiyu",18,"April",2013),
    new Student("Silva","Philips",19,"January",2010), new Student("Bamidele","Mu'aadh", 20,"July",2017)};
